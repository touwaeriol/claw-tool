  ...
  <div class="channels-view">
      ...
      >
        ...
        <div class="channel-footer">
          <div class="channel-footer-tags">
            ...
            >
              <el-tag
                :type="
                  savedTestRecords[channel.id].success === true
                    ? 'success'
                    : savedTestRecords[channel.id].success === false
                      ? 'danger'
                      : 'warning'
                "
                size="small"
        ...
        <div v-if="testStates[channel.id]?.result" class="channel-test-result">
          <el-alert
            ...
            :type="
              testStates[channel.id].result.success === true
                ? 'success'
                : testStates[channel.id].result.success === false
                  ? 'error'
                  : 'info'
            "
            :closable="true"
    ...
    >
      ...
      <el-alert
        ...
        :type="
          testStates[currentChannelId].result.success === true
            ? 'success'
            : testStates[currentChannelId].result.success === false
              ? 'error'
              : 'info'
        "
        :closable="true"
