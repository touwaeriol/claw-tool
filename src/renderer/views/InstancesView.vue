      ...
      >
        <div class="instance-main">
          ...
          <div class="instance-icon">
            <el-icon
              :size="32"
              :color="inst.type === 'local' ? 'var(--ct-primary)' : 'var(--ct-warning)'"
            >
          ...
          <div class="instance-info">
            ...
            <div class="instance-detail">
              <span v-if="inst.type === 'ssh'"
                >{{ inst.username }}@{{ inst.host }}:{{ inst.port || 22 }}</span
              >
            ...
            <div class="instance-meta">
              <span
                ...
                :class="{
                  ...
                  'status-dot--stopped':
                    instanceStore.connectionStatus[inst.id] === 'disconnected' ||
                    instanceStore.connectionStatus[inst.id] === 'error',
          ...
          <div class="instance-actions" @click.stop>
            <el-button
              v-if="
                inst.type === 'ssh' &&
                instanceStore.connectionStatus[inst.id] !== 'connected' &&
                instanceStore.connectionStatus[inst.id] !== 'connecting'
              "
              text
              size="small"
              type="primary"
