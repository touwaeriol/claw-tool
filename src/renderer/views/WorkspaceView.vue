...
async function saveWorkspaceFile() {
  const result = await store.saveWorkspaceFile(selectedWorkspaceFile.value, wsFileEditContent.value)
  if (result.success) {
    ElMessage.success(t('workspace.fileSaved'))
  } else {
    ElMessage.error(result.message)
          ...
          <div class="memory-editor-section">
            ...
            <template v-else>
              <div v-if="!store.memoryExists" class="empty-state-inline">
                ...
                <el-button size="small" type="primary" :loading="store.memorySaving" @click="createMemory">
                  {{ t('workspace.createDefault') }}
                </el-button>
              </div>
              <MarkdownEditor
          ...
          <div class="memory-sidebar">
            ...
            <div class="memory-status-section">
              <h4 class="section-title">
                ...
                <el-button size="small" :loading="store.memoryStatusLoading" @click="refreshMemoryStatus">
                  {{ t('common.refresh') }}
                </el-button>
                <el-button size="small" type="warning" :loading="store.memoryIndexing" @click="doRebuildIndex">
                  {{ t('workspace.rebuildIndex') }}
                </el-button>
              </h4>
              <pre v-if="store.memoryStatusOutput" class="status-output">{{ store.memoryStatusOutput }}</pre>
            </div>
            ...
            <div class="memory-logs-section">
              <h4 class="section-title">
                ...
                <el-button size="small" :loading="store.memoryLogsLoading" @click="store.loadMemoryLogs()">
              ...
              <div v-if="store.currentLogName" class="log-preview">
                <h4 class="section-title">{{ store.currentLogName }}</h4>
        ...
        <div class="tab-content skills-tab">
          ...
          <div class="skills-list-section">
            <div class="section-header">
              <h4 class="section-title">{{ t('workspace.installedSkills') }}</h4>
              <el-button size="small" :loading="store.skillsLoading" @click="store.loadInstalledSkills()">
                <el-icon><ElIconRefresh /></el-icon>
              </el-button>
            </div>
          ...
          <div class="files-editor">
            ...
            <template v-else>
              <div v-if="!store.workspaceFileExists" class="empty-state">
                <el-empty :description="t('workspace.fileNotExists', { name: selectedWorkspaceFile })">
                  <el-button type="primary" :loading="store.workspaceFileSaving" @click="createWorkspaceFile">
                    {{ t('workspace.createDefault') }}
                  </el-button>
                </el-empty>
              </div>
