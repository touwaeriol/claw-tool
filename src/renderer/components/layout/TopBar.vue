...
/* 主题切换 */
const isDark = computed(() => appStore.theme === 'dark' || (appStore.theme === 'system' && window.matchMedia('(prefers-color-scheme: dark)').matches))
...
<template>
  <el-header class="topbar" height="48px">
    ...
    <div class="topbar-right">
      <el-tag
        :type="serviceStore.gatewayRunning ? 'success' : 'info'"
        size="small"
      >
      ...
      <!-- 主题切换按钮 -->
      <el-tooltip :content="isDark ? t('settings.themeLight') : t('settings.themeDark')" placement="bottom">
        <el-button text size="small" class="topbar-icon-btn" @click="toggleTheme">
          ...
          <el-icon :size="18">
            <svg v-if="isDark" viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em">
              <!-- Sun icon -->
              <path d="M12 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm0 16a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zm8-8a1 1 0 011 1 1 1 0 01-1 1h-1a1 1 0 110-2h1zM5 11a1 1 0 110 2H4a1 1 0 110-2h1zm14.07-6.36a1 1 0 010 1.41l-.71.71a1 1 0 11-1.41-1.41l.71-.71a1 1 0 011.41 0zM7.05 16.95a1 1 0 010 1.41l-.71.71a1 1 0 11-1.41-1.41l.71-.71a1 1 0 011.41 0zm12.02.71a1 1 0 01-1.41 0l-.71-.71a1 1 0 111.41-1.41l.71.71a1 1 0 010 1.41zM7.05 7.05a1 1 0 01-1.41 0l-.71-.71a1 1 0 111.41-1.41l.71.71a1 1 0 010 1.41zM12 8a4 4 0 100 8 4 4 0 000-8z"/>
            </svg>
            <svg v-else viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em">
              <!-- Moon icon -->
              <path d="M12.1 22c-5.5 0-10-4.5-10-10 0-4.8 3.4-8.8 8.1-9.8.4-.1.8 0 1.1.3.3.3.3.7.2 1.1-.5 1.2-.7 2.5-.7 3.9 0 5 4 9 9 9 1.3 0 2.6-.3 3.8-.8.4-.2.9-.1 1.1.2.3.3.3.7.2 1.1-1.1 4.7-5.1 8-9.8 8z"/>
            </svg>
          </el-icon>
        </el-button>
      </el-tooltip>
