...
FeatureStatusDirect messages✅ SupportedGroups⚠️ Supported with policy controls (allowlist by default)Media (images)✅ SupportedReactions❌ Not supportedThreads❌ Not supportedPolls❌ Not supportedNative commands❌ Not supportedStreaming⚠️ Blocked (2000 char limit)
